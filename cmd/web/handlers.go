...
import (
	...
	"github.com/cosmicray001/snippetbox/internal/validator"
...
func (app *application) userSignup(w http.ResponseWriter, r *http.Request) {
	_, _ = fmt.Fprintln(w, "Display a HTML form for signing up a new user...")
}
...
func (app *application) userLogin(w http.ResponseWriter, r *http.Request) {
	_, _ = fmt.Fprintln(w, "Display a HTML form for logging in a user...")
}
